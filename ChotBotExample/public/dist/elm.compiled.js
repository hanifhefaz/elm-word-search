...
var $author$project$Pages$Chat$NotSearched = {$: 'NotSearched'};
var $author$project$Pages$Chat$init = function (_v0) {
	var params = _v0.params;
	return {searchResult: $author$project$Pages$Chat$NotSearched, searchString: ''};
};
...
var $hanifhefaz$elm_word2dict_matcher$QuestionsBank$data = _List_fromArray(
	[
...
var $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$Score = F2(
	function (a, b) {
...
var $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$toHistogram = A2(
	$elm$core$List$foldl,
	F2(
		function (key, dict) {
			var _v0 = A2($elm$core$Dict$get, key, dict);
...
var $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$stopWords = _List_fromArray(
...
var $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$tokenize = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			...
			$elm$core$List$filter(
				function (x) {
					return !A2($elm$core$List$member, x, $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$stopWords);
				}))));
var $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$score = F3(
	function (firstDict, answer, prevBest) {
		var thisHistogram = $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$toHistogram(
			$hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$tokenize(answer.question));
		...
		var _this = A2(
			$hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$Score,
			answer,
...
var $hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$findRelevantDict = F2(
	function (firstDict, answers) {
		var _v0 = A3(
			$elm$core$List$foldl,
			$hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$score(firstDict),
			$elm$core$Maybe$Nothing,
			answers);
		if (_v0.$ === 'Just') {
			var _v1 = _v0.a;
	...
	function (msg, model) {
		if (msg.$ === 'TypedSearch') {
			...
			return _Utils_update(
				model,
				{
					searchResult: $author$project$Pages$Chat$Searched(
						A2(
							$hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$findRelevantDict,
							$hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$toHistogram(
								$hanifhefaz$elm_word2dict_matcher$Word2DictMatcher$tokenize(model.searchString)),
							$hanifhefaz$elm_word2dict_matcher$QuestionsBank$data))
				});
		}
	});
var $author$project$Pages$Chat$Search = {$: 'Search'};
var $author$project$Pages$Chat$TypedSearch = function (a) {
	return {$: 'TypedSearch', a: a};
};
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Ask our Agent')
											])),
										A2(
										$elm$html$Html$p,
										_List_fromArray(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Events$onSubmit($author$project$Pages$Chat$Search)
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																...
																$elm$html$Html$Events$onInput($author$project$Pages$Chat$TypedSearch),
												...
												_List_fromArray(
													[
														A2($elm$html$Html$Attributes$style, 'width', '50%'),
														A2($elm$html$Html$Attributes$style, 'background-color', '#32CD32'),
														A2($elm$html$Html$Attributes$style, 'margin', 'auto'),
												...
												_List_fromArray(
													[
														...
														if (_v0.$ === 'NotSearched') {
															...
															if (_v0.a.$ === 'Nothing') {
																var _v1 = _v0.a;
																return $elm$html$Html$text('Sorry, there is no words in the bag :)');
															} else {
																var answer = _v0.a.a;
																return $elm$html$Html$text(answer.answer);
															}
														}
													}()
													]))
